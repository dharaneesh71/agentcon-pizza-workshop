...
file_ids = [
    ...
    for f in os.listdir("/workspaces/agentcon-pizza-workshop/workshop/documents")
    if os.path.isfile(os.path.join("/workspaces/agentcon-pizza-workshop/workshop/documents", f))
]
